...
class utily_class():
    ...
    def eda_MatchSimilarText_outPut(self):  # JIRA_ROHIT_PendingTask
        ...
        df_from_eda = matchSimilarText(
            df_for_eda, fuzziness, str_to_compare_with, column_index)
        ...
        if request.method == 'POST':
            ...
            if form_csv_to_psql.is_valid():
                ...
                try:
                    ...
                    database_name = settings.DATABASES['default']['NAME']
                    print(
                        "-------database_name----------AAAAAA------------", database_name)
                    print("     "*90)
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(
                    #         col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+");")

                    # elif len_ls_df == 3:
                    #     col_1_name = str(ls_cols[0])
                    #     col_2_name = str(ls_cols[1])
                    #     col_3_name = str(ls_cols[2])
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" " + "(" + str(col_1_name) + " " + " " + str(
                    #         col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(
                    #         col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(
                    #         col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(
                    #         col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+");")
                    ...
                    #         col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(
                    #         col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(
                    #         col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+","+str(col_9_name)+" "+" "+str(col_9_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(
                    #         col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+","+str(col_9_name)+" "+" "+str(col_9_dtype)+","+str(col_10_name)+" "+" "+str(col_10_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(
                    #         col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+","+str(col_9_name)+" "+" "+str(col_9_dtype)+","+str(col_10_name)+" "+" "+str(col_10_dtype)+","+str(col_11_name)+" "+" "+str(col_11_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(
                    #         col_6_name)+" "+" "+str(col_6_dtype)+","+str(col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+","+str(col_9_name)+" "+" "+str(col_9_dtype)+","+str(col_10_name)+" "+" "+str(col_10_dtype)+","+str(col_11_name)+" "+" "+str(col_11_dtype)+","+str(col_12_name)+" "+" "+str(col_12_dtype)+");")
                    ...
                    #     conn_cursor.execute("CREATE TABLE"+" "+str(new_table_name)+" "+"("+str(col_1_name)+" "+" "+str(col_1_dtype)+", "+str(col_2_name)+" "+" "+str(col_2_dtype)+","+str(col_3_name)+" "+" "+str(col_3_dtype)+","+str(col_4_name)+" "+" "+str(col_4_dtype)+","+str(col_5_name)+" "+" "+str(col_5_dtype)+","+str(col_6_name)+" "+" "+str(col_6_dtype)+","+str(
                    #         col_7_name)+" "+" "+str(col_7_dtype)+","+str(col_8_name)+" "+" "+str(col_8_dtype)+","+str(col_9_name)+" "+" "+str(col_9_dtype)+","+str(col_10_name)+" "+" "+str(col_10_dtype)+","+str(col_11_name)+" "+" "+str(col_11_dtype)+","+str(col_12_name)+" "+" "+str(col_12_dtype)+","+str(col_13_name)+" "+" "+str(col_13_dtype)+");")
                    ...
                    print(
                        "----UTILY----def csv_to_psql(request):-----ERRRRRRROORRRRRRR-----except Exception as e----------", e)
                    print("   "*90)
    ...
    def df_pandas_to_sql(self, df_pandas):
        ...
        df_pandas.to_sql(name='name_df_pandas2', con=engine,
    ...
    def scrapLnkd_view(request):
        ...
        latest_Lnkd_ls = model_init_lnkd.objects.all().order_by(
            '-TimeStamp', '-pk')[0:1]
        ...
        if len(latest_Lnkd_ls) > 0:
            for k in range(len(latest_Lnkd_ls)):
                ...
                parms["google_per_page_soup_ls"] = objLnkd.init_scrap_linkedin(
                    str(latest_Lnkd_ls[k].createdStr_lnkd))
    ...
    def initSearchTracxn_view(request):
        ...
        try:
            if request.method == 'POST':
                ...
                form = initSearchTracxn(request.POST)
                ...
                if form.is_valid():
                    ...
                    InitStrSearch = traxcn_str_1 + " " + \
                        str(InitStrSearch) + " " + traxcn_str_2
                    initSearchTracxn_ls.append(str(InitStrSearch))

                    searchPortal_ls.append("Tracxn")
                    dt_now_ls.append(str(dt_now))
            df_tracxn = pd.DataFrame({'initSearchStr': ls_InitStrSearch, 'initSearchStrTracxn': initSearchTracxn_ls,
                                      'SearchPortal': searchPortal_ls, 'TimeStamp': dt_now_ls})
    ...
    def scrapTracxn_view(request):
        ...
        # objTracxn = Startup_Scraper()
        latest_Tracxn_list = model_SearchTracxn.objects.all().order_by(
            '-TimeStamp')[0:3]  # TBD --- Change -
        if len(latest_Tracxn_list) > 0:
            for k in range(len(latest_Tracxn_list)):
                all_soups_list = objTracxn.scrapingTracxn(
                    str(latest_Tracxn_list[k].initSearchStrTracxn))
        ...
        ls_org_name_main, ls_org_url_main, ls_comparables_org_urls, ls_comparables_org_urls_others, ls_comparables_org_name, ls_comparables_org_name_others = objTracxn.parse_soup_tcxn(
            str_soup_inFile)
        ...
        df_tracxn_others = pd.DataFrame({'MAIN_Org_NAME': ls_comparables_org_name, 'MAIN_Org_URL': ls_comparables_org_urls,
                                         'Others_Org_NAME': ls_comparables_org_name_others, 'Others_Org_URL': ls_comparables_org_urls_others, 'TimeStamp': dt_now_ls})
        ...
        #     #print("    "*90)
        # As of Now Returns -- init_search_2.html
        return render(request, 'dc_dash/init_search_2.html')
    ...
    def summary_stats_1(request):
        ...
        # LONG Returns below
        df_forJSON, df_data1, list_str2, list_str3, ls_eng_levl, ls_linkedin, ls_org_img, ls_reg_coy, ls_stage, ls_indus, ls_sector, ls_loc, ls_about_me, ls_timeStamp = obj.parse_soup(
            str_soup_inFile)
        ...
        zipped_lists = zip(list_str2, list_str3, ls_eng_levl, ls_linkedin, ls_org_img,
                           ls_reg_coy, ls_stage, ls_indus, ls_sector, ls_loc, ls_about_me, ls_timeStamp)
    ...
    def summary_stats_2(request):
        ...
        for field in fields_list:
            obj = summary_stat()
            sum_obj, mean_obj, min_obj, max_obj, median_1, lowerQ, upperQ = obj.sum_stat_1(
                mod_name, field)
            # ENSURE -- objects RETURNED in same ORDER as RETURN from "summary_stats_1.py" FUNC
            ...
            zipped_lists = zip(cols_list, sum_obj_list, mean_obj_list, min_obj_list,
                               max_obj_list, medians_list, lowerQ_list, upperQ_list)
    ...
    def chart_1(request):
        ...
        col_names_from_model_1 = model_1_col_names.objects.all().values(
            'f1')[0:5]  # Only 1-5 Colmn names to display
        ls_cols_1 = list(col_names_from_model_1)
        cols_list_1 = [x['f1'] for x in ls_cols_1]

        col_names_from_model_2 = model_2_col_names.objects.all().values(
            'f1')[0:5]  # Only 1-5 Colmn names to display
        ls_cols_2 = list(col_names_from_model_2)
        cols_list_2 = [x['f1'] for x in ls_cols_2]

        col_names_from_model_3 = model_3_col_names.objects.all().values(
            'f1')[0:5]  # Only 1-5 Colmn names to display
        ls_cols_3 = list(col_names_from_model_3)
        cols_list_3 = [x['f1'] for x in ls_cols_3]

        col_names_from_model_4 = model_4_col_names.objects.all().values(
            'f1')[0:5]  # Only 1-5 Colmn names to display
